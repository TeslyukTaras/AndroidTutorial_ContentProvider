package com.teslyuk.androidtutorial_contentprovider.adapter;
...
import com.teslyuk.androidtutorial_contentprovider.R;
...
public class LogListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.name = (TextView) view.findViewById(R.id.item_log_name);
            viewHolder.delete = (ImageView) view.findViewById(R.id.item_log_remove);
